...
#### Synchronizing (locking) VCORE, V1P8, V3P3 and VUSB regulators swithcing frequency:
...
- syncronizing SMPS regulators is a simple method to reduce the ripple noise 
